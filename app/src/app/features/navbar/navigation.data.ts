export const NAVPAGES = [
    ...
    // { visible: false, title: 'CONHEÇA O EVENTO', route: '/about', description: 'Conheça o #CapiConf' },
     ...
     //{ visible: false, title: 'AGENDA', route: '/agenda', description: 'A agenda do evento' },
    // { visible: false, title: 'Patrocínio e Apoio', route: '/partners', description: 'Patrocínio e Apoio' },
     //{ visible: false, title: 'AJUDA', route: '/faq', description: 'Precisa de ajuda? Aqui temos algumas respostas' },
